// src/components/OneSignalNotificationSettings.tsx
...
export const OneSignalNotificationSettings: React.FC = () => {
  ...
  const checkNotificationStatus = async () => {
    try {
      ...
      console.error('[OneSignalSettings] Error checking status:', error);
  ...
  const handleOneSignalSubscribe = async () => {
    ...
    try {
      ...
      if (success) {
        ...
        console.log('[OneSignalSettings] Successfully subscribed to OneSignal');
      } else {
        throw new Error('Failed to subscribe to OneSignal notifications');
      }
    } catch (error) {
      console.error('[OneSignalSettings] Subscribe error:', error);
  ...
  const handleOneSignalUnsubscribe = async () => {
    ...
    try {
      ...
      if (success) {
        await checkNotificationStatus();
        console.log('[OneSignalSettings] Successfully unsubscribed from OneSignal');
      } else {
        throw new Error('Failed to unsubscribe from OneSignal notifications');
      }
    } catch (error) {
      console.error('[OneSignalSettings] Unsubscribe error:', error);
  ...
  const handleTestNotification = async () => {
    ...
    try {
      ...
      console.log('[OneSignalSettings] Test notification sent');
    } catch (error) {
      console.error('[OneSignalSettings] Test notification error:', error);
...
export default OneSignalNotificationSettings;
